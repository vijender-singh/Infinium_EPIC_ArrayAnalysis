...
pheno <- read.csv("samplesheet_mother.csv") # PHENOTYPE FILE - HERE
...
###Empty data.table (0 rows and 2 cols): SampleID,donor_id


# Save the phenotype file with the QC details
write.csv(pheno, file = "mother_Pheno_QC_01.csv", row.names = F)

# Converting continous variables to Z-score.
phenoScaled=pheno
...
write.csv(phenoScaled, file = "mother_PhenoScaled_QC_01.csv", row.names = F)
